...
export default function ProductList  () {
    ...
    return <div className="light:bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
        <div className="mx-auto px-4 ">            
            <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
                ...
                <div className="flex items-center space-x-4">
                    <button onClick={() => setFilterModal(!filterModal)}   type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
                    ...
                    <div className="relative">
                        ...
                        {
                            sortModal ?
                                <div id="dropdownSort1" className="z-100 absolute right-0 w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-gray-700" data-popper-placement="bottom">
            ...
            <div className="mb-4 grid gap-4 grid-cols-2 sm:grid-cols-2 md:mb-8 lg:grid-cols-4 xl:grid-cols-6">                
                {products.map((prod,id) => {
                    return <Product key={id} title={prod.title} price={prod.price} discount={prod.discountPercentage} image={prod.thumbnail} />
                })}
            </div>
        ...
        <form action="#" method="get" id="filterModal" tabIndex="-1" aria-hidden="true" className={!filterModal ? 'hidden' : " left-0 right-0 top-0 z-50 h-modal w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0 md:h-full"}>
